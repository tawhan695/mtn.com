...
return [
    ...
    */
    ...
    'logo' => '<b>มัทนาไข่สด</b>MTN',
    'logo_img' => 'images/brand.png',
    ...
    */
    ...
    'menu' => [
        ['header' => 'ผู้จัดการ','can'  => 'Manager-menu',],
            [
                'text' => 'search',
                'search' => false,
                'topnav' => false,
            ...
            [
                ...
                'submenu' => [
                    [
                        'text' => 'สาขา 1',
                        'url'  => '#',
                        'icon' => 'nav-icon fas fa-map-marker'
                    ],
                    [
                        'text' => 'สาขา 2',
                        'url'  => '#',
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'คลังสินค้า',
                    'route'  => 'admin.StockProducts.index',
                    'icon' => 'nav-icon far fa-circle text-warning'
                ],
                [
                    'text' => 'โอนสินค้าระหว่างสาขา',
                    'route'  => 'admin.ChangeProducts.index',
                    'icon' => 'nav-icon far fa-circle text-warning'
                ],
                [
                    'text' => 'รับสินค้าเข้าคลัง',
                    'route'  => 'admin.ImportProducts.index',
                    'icon' => 'nav-icon far fa-circle text-warning'
                ],
                [
                    'text' => 'รับคืนสินค้า',
                    'route'  => 'admin.ReturnProducts.index',
                    'icon' => 'nav-icon far fa-circle text-warning'
                ],
               
                [
                    'text' => 'สินค้าชำรุด',
                    'route'  => 'admin.DefectiveProducts.index',
                    'icon' => 'nav-icon far fa-circle text-warning'
                ],
            ],
        ],
